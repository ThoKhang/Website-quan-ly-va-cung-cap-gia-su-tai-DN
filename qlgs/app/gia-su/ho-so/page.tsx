// Đường dẫn: app/gia-su/ho-so/page.tsx
"use client";
...
export default function GiaSuHoSo() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.tenGiaSu || !formData.sdt || !formData.cccd) {
    ...
    try {
      ...
      await giaSuService.createProfile({
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <Text as="label" size="caption" className="font-semibold block mb-2">
                  Tên Gia Sư <span className="text-red-600">*</span>
                </Text>
                <input
                  type="text"
                  name="tenGiaSu"
              ...
              <div>
                <Text as="label" size="caption" className="font-semibold block mb-2">
                  CCCD <span className="text-red-600">*</span>
                </Text>
                <input
                  type="text"
                  name="cccd"
